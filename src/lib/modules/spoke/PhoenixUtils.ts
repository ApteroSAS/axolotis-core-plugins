...
export function createHubChannelParams(authToken: string | null = null, permsToken: string | null = null) {
    /*{
        "profile": {
...
export async function load(hubid):Promise<{data:any,hubPhxChannel:any,vapiddata:any}> {
    const socket = await connectToReticulum();
    socket.onClose(e => {
        console.error(e);
    });

    const {data,hubPhxChannel,vapiddata} = await new Promise((resolve, reject) => {
