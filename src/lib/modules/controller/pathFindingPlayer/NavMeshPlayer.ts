...
export class Factory implements WebpackLazyModule, ComponentFactory<NavMeshPlayer> {
    async createComponent(world: WorldEntity, config: any): Promise<NavMeshPlayer> {
        ...
        let input = await services.getService<Input>("@root/lib/modules/controller/pathFindingPlayer/Input");
