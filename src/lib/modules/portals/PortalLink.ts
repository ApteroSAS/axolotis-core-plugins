...
export class Factory
    ...
    async createComponent(
        ...
        let codeLoader = await services.getService<CodeLoaderComponent>("@aptero/axolotis-player/modules/core/loader/CodeLoaderService");
        let three = await services.getService<ThreeLib>("@aptero/axolotis-core-plugins/modules/three/ThreeLib");
        let service = await services.getService<PortalsService>("@aptero/axolotis-core-plugins/modules/portals/PortalsService");
        let playerService = await services.getService<PlayerService>("@aptero/axolotis-core-plugins/modules/controller/PlayerService");
